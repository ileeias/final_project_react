        ...
        <nav className="header_nav_after">
          <div className="header_nav_after_base">
            ...
            {show && (
              <div className="media_list">
                <Link to="/photos" className="media_link">
                  Photo
                </Link>
                <Link to="/videos" className="media_link">
                  Video
                </Link>
                <Link to="/albums" className="media_link">
                  Albums
                </Link>
              </div>
            )}
          ...
          <div className="header_nav_after_end">
            <Link to="/" className="link" onClick={removeToken}>
              <IoExitSharp className="exit_icon" />
            </Link>
            <IoMdSettings className="settings_icon" onClick={chengeTheme} />
          </div>
          {showTheme && (
            <div className="setting">
              <button onClick={toggleTheme} className='theme_button'>
